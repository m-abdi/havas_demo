...
import AssetExitWorkflowsTables from '../../../pages/users/assetExitWorkflowsTables';
import StoriesDecorator from '../../StoriesDecorator';

export default {
  title: 'Pages/AssetExitWorkflowsTables',
  component: AssetExitWorkflowsTables,
  decorators: [
    (Story) => (
      <StoriesDecorator>
        <Story />
...
} as ComponentMeta<typeof AssetExitWorkflowsTables>;

const Template: ComponentStory<typeof AssetExitWorkflowsTables> = (args) => <AssetExitWorkflowsTables {...args} />;
let itemsPerPage = 10;

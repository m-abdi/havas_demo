...
export default {
  title: 'Components/ContradictionTable',
  component: ContradictionTable,
  decorators: [
    (Story) => (
      <StoriesDecorator>
        <Story />
...
} as ComponentMeta<typeof ContradictionTable>;

// More on component templates: https://storybook.js.org/docs/react/writing-stories/introduction#using-args
const Template: ComponentStory<typeof ContradictionTable> = (args) => <ContradictionTable {...args} />;

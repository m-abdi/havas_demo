...
export default {
  title: 'Pages/ConfirmReceiptByCorporations',
  component: ConfirmReceiptByCorporations,
  decorators: [
    (Story) => (
      <StoriesDecorator>
        <Story />
...
} as ComponentMeta<typeof ConfirmReceiptByCorporations>;

const Template: ComponentStory<typeof ConfirmReceiptByCorporations> = (args) => (
  <ConfirmReceiptByCorporations {...args} />
);
let itemsPerPage = 10;

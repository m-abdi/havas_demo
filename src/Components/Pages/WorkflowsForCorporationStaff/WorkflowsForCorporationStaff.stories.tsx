...
export default {
  title: 'Pages/WorkflowsForCorporationStaff',
  component: WorkflowsForCorporationStaff,
  decorators: [
    (Story) => (
      <StoriesDecorator>
        <Story />
...
} as ComponentMeta<typeof WorkflowsForCorporationStaff>;

const Template: ComponentStory<typeof WorkflowsForCorporationStaff> = (args) => (
  <WorkflowsForCorporationStaff {...args} />
);
let itemsPerPage = 10;

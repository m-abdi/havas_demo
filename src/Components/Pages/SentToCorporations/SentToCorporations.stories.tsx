...
export default {
  title: 'Pages/SentToCorporations',
  component: SentToCorporations,
  decorators: [
    (Story) => (
      <StoriesDecorator>
        <Story />
...
} as ComponentMeta<typeof SentToCorporations>;

const Template: ComponentStory<typeof SentToCorporations> = (args) => (
  <SentToCorporations {...args} />
);
let itemsPerPage = 10;
